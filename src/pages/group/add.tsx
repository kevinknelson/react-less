...
export default function GroupEdit( props : IProps ) {
    ...
    const returnUrl = props?.returnUrl ?? params.get('returnUrl', '/group');
    const form      = useForm<Group>(GroupApi, GroupFormMapper, GroupValidation, null, returnUrl);

    return <GroupAddEditForm form={form} />
}
